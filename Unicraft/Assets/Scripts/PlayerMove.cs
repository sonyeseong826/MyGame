...
public class PlayerMove : MonoBehaviour
{
    ...
    float xRotation; // 마우스 X각도
    float yRotation; // 마우스 Y각도
    public Camera cam; // 카메라 가져오기
    InvenTab invenTab;
    ...
    void Start()
    {
        ...
        invenTab = FindObjectOfType<InvenTab>();
    }
    ...
    void Move()
    {
        ...
        if (Input.GetKey(KeyCode.LeftShift))
        {
            ...
            capsule.center = new Vector3(-0.5f, crouchHeight / 2, 0); // 충돌 박스 중심도 조정
        }
        ...
        else
        {
            ...
            capsule.center = new Vector3(-0.5f, originalHeight / 2, 0);
        }
